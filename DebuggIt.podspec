#
#  Be sure to run `pod spec lint DebuggIt.podspec' to ensure this is a
...
DebuggIt is a simple, yet powerful tool that helps you get reports of the bugs directly to your defined issue tracker. It is a perfect tool for QA/clients.
  ...
  # Or just: s.author    = "bsmektal"
  # s.authors            = { "bsmektal" => "bs.smektala@gmail.com" }
  # s.social_media_url   = "http://twitter.com/bsmektal"
  ...
  # s.resource  = "icon.png"
  s.resources = "DebugIt/**/*.{png,jpeg,jpg,storyboard,xib}"
